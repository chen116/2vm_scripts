...
mkdir -p /root/experiment-scripts/run-data-fig2/"$PROG"/
mkdir /root/experiment-scripts/run-data-fig2/"$PROG"/"$Dist""_""$PDist""_""$util""_""$rep"/
#mkdir run-data-fig2/"$PROG"/"$Dist""_""$PDist""_""$util""_""$rep"_"$j"/
mv /dev/shm/*.bin /root/experiment-scripts/run-data-fig2/"$PROG"/"$Dist""_""$PDist""_""$util""_""$rep"/
