...
#./run_bench_Array_granular.sh myapp uni-light 40000 uni-moderate && \
#./run_bench_Array_granular.sh myapp uni-light 10800 uni-moderate && \
~/experiment-scripts/run_bench_Array_granular.sh myapp uni-light 4000 uni-moderate && \
